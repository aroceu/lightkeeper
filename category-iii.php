<!-- 
Category Chapter 3 All Posts
-->

<?php get_header(); ?>

<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/templates/exhibit/styles/ch-3.css" type="text/css" media="screen" /> <!-- Chapter 3 stylesheet -->
