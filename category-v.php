<!-- 
Category Chapter 5 All Posts
-->

<?php get_header(); ?>

<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/templates/exhibit/styles/ch-5.css" type="text/css" media="screen" /> <!-- Chapter 5 stylesheet -->
